...
.jump_to_right:
	...
	bit	5, a
	ld	a, [$C101]
	cp	$93			; Grunio again can't leave the screen
	jp	z, .check_A_button
	ld	hl, $C101
	ld	b, 6
...
DB $4C,$4C,$4C,$4C,$38,$38,$00,$00
DB $38,$38,$2C,$2C,$2C,$2C,$30,$30
DB $28,$28,$2C,$2C,$2C,$2C,$00,$00
DB $3C,$3C,$20,$20,$20,$20,$3C,$3C
